...
func (c *beaconClient) Signal(ctx context.Context, in *SignalRequest, opts ...grpc.CallOption) (*SignalResponse, error) {
	out := new(SignalResponse)
	err := c.cc.Invoke(ctx, "/Beacon/Signal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBeaconServer) Signal(context.Context, *SignalRequest) (*SignalResponse, error) {
...
func _Beacon_Signal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Beacon/Signal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconServer).Signal(ctx, req.(*SignalRequest))
	}
...
var Beacon_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/protos/beacon.proto",
}
